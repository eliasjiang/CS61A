...
def missing_digits(n):
    ...
    if n<10:
        ...
        fst,scd = n//10%10,n%10
        return max((scd-fst-1),0)+missing_digits(n//10)
...
def count_change(total):
    ...
    maxCent = find_twoTh(total)
    def helper(total,maxCent):
        if total ==0:
            return 1
        elif total<0:
            return 0
            ...
            return helper(total-maxCent,maxCent)+helper(total,maxCent//2)


    return helper(total,maxCent)
