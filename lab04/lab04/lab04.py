...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    nearCity = make_city("nearCity",lat,lon)

    dis_a = distance(nearCity,city_a)
    dis_b = distance(nearCity,city_b)

    return get_name(city_b) if(dis_a>dis_b) else get_name(city_a)
